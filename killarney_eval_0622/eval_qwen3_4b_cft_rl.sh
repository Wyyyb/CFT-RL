...
checkpoint_numbers=(100 120 140 160 180 200 220 240 260 280)
...
for ckpt_num in "${checkpoint_numbers[@]}"; do
    summary_path="/scratch/y726wang/CFT-RL/eval_results_qwen3_4b_cft_0621_rl/summary.txt"
    saved_ckpt_path="/scratch/y726wang/CFT-RL/verl-data/save_checkpoints/cft-rl-0621_webinstruct-verified_qwen3_4b_cft_ckpt40/global_step_${ckpt_num}/actor/"
    model_path="/scratch/y726wang/CFT-RL/verl-data/output_models/cft-rl-0621_webinstruct-verified_qwen3_4b_cft_ckpt40/ckpt-${ckpt_num}"
    output_path="/scratch/y726wang/CFT-RL/eval_results_qwen3_4b_cft_0621_rl/ckpt-${ckpt_num}/"
